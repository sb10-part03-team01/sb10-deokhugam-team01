...
public enum ErrorCode {
  ...
  // popular review
  POPULAR_REVIEW_REVIEW_REQUIRED(400, "POPULAR_REVIEW_REVIEW_REQUIRED", "리뷰는 필수입니다."),
  POPULAR_REVIEW_PERIOD_REQUIRED(400, "POPULAR_REVIEW_PERIOD_REQUIRED", "기간은 필수입니다."),
  POPULAR_REVIEW_INVALID_RANK(400, "POPULAR_REVIEW_INVALID_RANK", "순위는 1 이상이어야 합니다."),
  POPULAR_REVIEW_INVALID_SCORE(400, "POPULAR_REVIEW_INVALID_SCORE", "점수는 유효한 숫자여야 합니다."),
  POPULAR_REVIEW_INVALID_LIKE_COUNT(400, "POPULAR_REVIEW_INVALID_LIKE_COUNT",
      "좋아요 수는 0 이상이어야 합니다."),
